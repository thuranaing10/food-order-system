                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                ...
                                while($drow=$dquery->fetch_array()){
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"> <?php echo number_format($drow['price']); ?></td>
                            ...
                            <tr>
                                ...
                                <td class="text-right">MMK <?php echo number_format($row['total']); ?></td>
                            </tr>
                        </tbody>
                    </table>
...
<div class="modal fade" id="detail<?php echo $row['purchaseid']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
