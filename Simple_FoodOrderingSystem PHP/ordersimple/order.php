			...
			<tbody>
				<?php 
					...
					while($row=$query->fetch_array()){
						?>
						<tr>
							<td class="text-center"><input type="checkbox" value="<?php echo $row['productid']; ?>||<?php echo $iterate; ?>"
							name="productid[]" id="checkbox" onchange="ShiptoBill()" style=""></td>
	
							<td><?php echo $row['catname']; ?></td>
							<td><?php echo $row['productname']; ?></td>
							<td class="text-left">&#x20A8; <?php echo number_format($row['price'], 2); ?></td>
							<td><input type="number" class="form-control" name="quantity_<?php echo $iterate; ?>" min = "1" id="txtunit"></td>
						</tr>
						<?php
						$iterate++;
					}
